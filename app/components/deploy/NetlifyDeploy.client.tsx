...
export function useNetlifyDeploy() {
  ...
  const handleNetlifyDeploy = async () => {
    ...
    try {
      ...
      // Build succeeded, 'Build Successful' alert should be active now.
      // We wait a bit before starting the deployment notification to let the user see the build success message.
