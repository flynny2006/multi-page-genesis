              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    disabled={connecting}
                    placeholder="Enter your Supabase access token here!"
                  ...
                  <div className="mt-2 text-sm text-bolt-elements-textSecondary">
                    ...
                    >
                      Get your token by clicking here
                ...
                <div className="flex justify-end gap-2 mt-6">
                  <DialogClose asChild>
                    <DialogButton type="secondary">Go Back</DialogButton>
                  </DialogClose>
                  <button
