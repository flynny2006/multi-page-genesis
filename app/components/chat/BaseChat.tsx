...
import { creditsStore } from '~/lib/stores/credits';
            ...
            {!chatStarted && (
              <div id="intro" className="mt-[16vh] max-w-chat mx-auto text-center px-4 lg:px-0">
                <h1 className="text-3xl lg:text-6xl font-bold text-bolt-elements-textPrimary mb-4 animate-fade-in">
                  Boongle AI - The AI Software Engineer
                </h1>
                <p className="text-md lg:text-xl mb-8 text-bolt-elements-textSecondary animate-fade-in animation-delay-200">
                  Build fullstack web and mobile applications in seconds.
                </p>
              </div>
            )}
            <StickToBottom
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div
                    className={classNames(
                      'relative shadow-lg border border-red-200 dark:border-red-800 backdrop-blur-sm rounded-xl transition-all duration-300 hover:shadow-xl hover:border-red-300 dark:hover:border-red-700',
                    )}
                  >
                    <textarea
                      ref={textareaRef}
                      className={classNames(
                        ...
                        'focus:ring-2 focus:ring-red-500/20 dark:focus:ring-red-500/20',
                      )}
                      onDragEnter={(e) => {
                        e.preventDefault();
                    ...
                    <div className="flex justify-between items-center text-sm p-4 pt-2">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="text-xs text-bolt-elements-textTertiary">
                          Credits: {useStore(creditsStore)}/15
                        </div>
                      </div>
                      <SupabaseConnection />
