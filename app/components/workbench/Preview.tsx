          ...
          <div className="flex items-center relative">
            ...
            {isWindowSizeDropdownOpen && (
              <>
                ...
                <div className="absolute right-0 top-full mt-2 z-50 min-w-[280px] max-h-[400px] overflow-y-auto bg-white dark:bg-black rounded-xl shadow-2xl border border-[#E5E7EB] dark:border-[rgba(255,255,255,0.1)] overflow-hidden">
                  <div className="p-3 border-b border-[#E5E7EB] dark:border-[rgba(255,255,255,0.1)]">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="grid grid-cols-2 gap-2 mb-2">
                        <button
                          className={`flex flex-col items-center justify-center text-start bg-transparent text-xs text-bolt-elements-textTertiary hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors duration-200 p-3 rounded-lg border border-gray-100 dark:border-gray-800`}
                          onClick={() => {
                            openInNewTab();
                          }}
                        >
                          <div className="i-ph:arrow-square-out h-6 w-6 mb-1" />
                          <span>New Tab</span>
                        </button>
                        <button
                          className={`flex flex-col items-center justify-center text-start bg-transparent text-xs text-bolt-elements-textTertiary hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors duration-200 p-3 rounded-lg border border-gray-100 dark:border-gray-800`}
                        ...
                        >
                          <div className="i-ph:browser h-6 w-6 mb-1" />
                      ...
                      <div className="grid grid-cols-2 gap-2 mb-2">
                        ...
                        >
                          <div className="i-ph:arrow-clockwise h-6 w-6 mb-1" />
                          <span>Refresh</span>
                        </button>
                        <button
                          className={`flex flex-col items-center justify-center text-start bg-transparent text-xs text-bolt-elements-textTertiary hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors duration-200 p-3 rounded-lg border border-gray-100 dark:border-gray-800`}
                        ...
                        >
                          <div className="i-ph:arrows-out h-6 w-6 mb-1" />
                          <span>Fullscreen</span>
                        </button>
                      </div>

                      {/* Tools Section */}
                      <div className="space-y-2 p-2 bg-gray-50 dark:bg-gray-900/50 rounded-lg mb-2">
                        <div className="text-xs font-medium text-gray-500 dark:text-gray-400 mb-2">Tools</div>
                        <div className="grid grid-cols-2 gap-2">
                          ...
                          >
                            <div className="i-ph:selection h-6 w-6 mb-1" />
                          ...
                          >
                            <div className="i-ph:qr-code h-6 w-6 mb-1" />
                            <span>QR Code</span>
                          </button>
                        </div>
                        <div className="grid grid-cols-2 gap-2">
                          ...
                          >
                            <div className="i-ph:monitor h-6 w-6 mb-1" />
                          ...
                          >
                            <div className="i-ph:printer h-6 w-6 mb-1" />
                            <span>Print</span>
                          </button>
                        </div>
                      </div>
                      ...
                      <div className="space-y-2 p-2 bg-gray-50 dark:bg-gray-900/50 rounded-lg mb-2">
                        <div className="text-xs font-medium text-gray-500 dark:text-gray-400 mb-2">View Options</div>
                        <div className="grid grid-cols-2 gap-2">
                          <button
                            className={`flex flex-col items-center justify-center text-start bg-transparent text-xs text-bolt-elements-textTertiary hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors duration-200 p-3 rounded-lg border border-gray-100 dark:border-gray-800`}
                            onClick={() => {
                          ...
                          >
                            <div className="i-ph:arrow-up h-6 w-6 mb-1" />
                          ...
                          >
                            <div className="i-ph:arrow-down h-6 w-6 mb-1" />
                          ...
                          <button
                            ...
                            onClick={() => {
                              if (iframeRef.current) {
                                const iframe = iframeRef.current;
                                if (iframe.contentWindow) {
                                  iframe.contentWindow.document.body.style.zoom = "1.0";
                                }
                              }
                            }}
                          >
                            <div className="i-ph:magnifying-glass h-6 w-6 mb-1" />
                          ...
                          <button
                            ...
                            onClick={() => {
                              if (iframeRef.current) {
                                const iframe = iframeRef.current;
                                if (iframe.contentWindow) {
                                  const currentZoom = parseFloat(iframe.contentWindow.document.body.style.zoom || "1.0");
                                  iframe.contentWindow.document.body.style.zoom = (currentZoom + 0.1).toString();
                                }
                              }
                            }}
                          >
                            <div className="i-ph:magnifying-glass-plus h-6 w-6 mb-1" />
                            <span>Zoom In</span>
                          </button>
                        </div>
                      </div>
                      ...
                      <div className="space-y-2 p-2 bg-gray-50 dark:bg-gray-900/50 rounded-lg mb-2">
                        <div className="text-xs font-medium text-gray-500 dark:text-gray-400 mb-2">Advanced Controls</div>
                        <div className="grid grid-cols-2 gap-2">
                          <button
                            className={`flex flex-col items-center justify-center text-start bg-transparent text-xs text-bolt-elements-textTertiary hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors duration-200 p-3 rounded-lg border border-gray-100 dark:border-gray-800`}
                            onClick={() => {
                          ...
                          >
                            <div className="i-ph:magnifying-glass-minus h-6 w-6 mb-1" />
                            <span>Zoom Out</span>
                          </button>
                          <button
                            className={`flex flex-col items-center justify-center text-start bg-transparent text-xs text-bolt-elements-textTertiary hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors duration-200 p-3 rounded-lg border border-gray-100 dark:border-gray-800`}
                            onClick={() => {
                              if (iframeRef.current) {
                                const iframe = iframeRef.current;
                                if (iframe.contentWindow) {
                                  iframe.contentWindow.document.body.style.filter = "grayscale(100%)";
                                }
                              }
                            }}
                          >
                            <div className="i-ph:image-square h-6 w-6 mb-1" />
                            <span>Grayscale</span>
                          </button>
                        </div>
                        <div className="grid grid-cols-2 gap-2">
                          <button
                            ...
                            onClick={() => {
                              if (iframeRef.current) {
                                const iframe = iframeRef.current;
                                if (iframe.contentWindow) {
                                  iframe.contentWindow.document.body.style.filter = "invert(100%)";
                                }
                              }
                            }}
                          >
                            <div className="i-ph:image h-6 w-6 mb-1" />
                          ...
                          <button
                            ...
                            onClick={() => {
                              if (iframeRef.current) {
                                const iframe = iframeRef.current;
                                if (iframe.contentWindow) {
                                  iframe.contentWindow.document.body.style.filter = "none";
                                }
                              }
                            }}
                          >
                          ...
                          <button
                            ...
                            onClick={() => {
                              if (iframeRef.current) {
                                const iframe = iframeRef.current;
                                if (iframe.contentWindow) {
                                  iframe.contentWindow.document.body.style.transform = "rotate(90deg)";
                                }
                              }
                            }}
                          >
                            <div className="i-ph:rotate-clockwise h-6 w-6 mb-1" />
                            <span>Rotate 90°</span>
                          </button>
                          <button
                            className={`flex flex-col items-center justify-center text-start bg-transparent text-xs text-bolt-elements-textTertiary hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors duration-200 p-3 rounded-lg border border-gray-100 dark:border-gray-800`}
                            onClick={() => {
                              if (iframeRef.current) {
                                const iframe = iframeRef.current;
                                if (iframe.contentWindow) {
                                  iframe.contentWindow.document.body.style.transform = "none";
                                }
                              }
                            }}
                          >
                            <div className="i-ph:rotate-counter-clockwise h-6 w-6 mb-1" />
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          ...
                          >
                            <div className="i-ph:lock h-6 w-6 mb-1" />
                          ...
                          >
                            <div className="i-ph:lock-open h-6 w-6 mb-1" />
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          <button
                            ...
                            onClick={() => {
                              if (iframeRef.current) {
                                const iframe = iframeRef.current;
                                if (iframe.contentWindow) {
                                  iframe.contentWindow.document.body.style.opacity = "0.5";
                                }
                              }
                            }}
                          >
                            <div className="i-ph:ghost h-6 w-6 mb-1" />
                          ...
                          >
                            <div className="i-ph:eye h-6 w-6 mb-1" />
                      ...
                      <div className="space-y-2 p-2 bg-gray-50 dark:bg-gray-900/50 rounded-lg">
                        <div className="text-xs font-medium text-gray-500 dark:text-gray-400 mb-2">Display Settings</div>
                        <div className="flex items-center justify-between p-2 rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors duration-200">
                          <div className="flex items-center gap-2">
                            <div className="i-ph:device-mobile h-4 w-4 text-gray-500" />
                            <span className="text-xs text-bolt-elements-textTertiary">Device Frame</span>
                          </div>
                          <button
                            className={`w-10 h-5 rounded-full transition-colors duration-200 ${
                              showDeviceFrame ? 'bg-red-500' : 'bg-gray-300 dark:bg-gray-700'
                            } relative`}
                            onClick={(e) => {
                              e.stopPropagation();
                        ...
                        <div className="flex items-center justify-between p-2 rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors duration-200">
                          <div className="flex items-center gap-2">
                            <div className="i-ph:device-rotate h-4 w-4 text-gray-500" />
                            <span className="text-xs text-bolt-elements-textTertiary">Landscape Mode</span>
                          </div>
                          <button
                            className={`w-10 h-5 rounded-full transition-colors duration-200 ${
                              isLandscape ? 'bg-red-500' : 'bg-gray-300 dark:bg-gray-700'
                            } relative`}
                            onClick={(e) => {
                              e.stopPropagation();
                  ...
                  <div className="p-2 bg-gray-50 dark:bg-gray-900/50">
                    <div className="text-xs font-medium text-gray-500 dark:text-gray-400 mb-2 px-2">Device Presets</div>
                    {WINDOW_SIZES.map((size) => (
                      <button
                        key={size.name}
                        className="w-full px-4 py-3 text-left text-[#111827] dark:text-gray-300 text-sm whitespace-nowrap flex items-center gap-3 group hover:bg-red-50 dark:hover:bg-red-900/20 bg-white dark:bg-black transition-colors duration-200 rounded-lg"
                        onClick={() => {
                      ...
                      >
                        <div
                          className={`${size.icon} w-5 h-5 text-[#6B7280] dark:text-gray-400 group-hover:text-red-500 dark:group-hover:text-red-500 transition-colors duration-200`}
                        />
                        <div className="flex-grow flex flex-col">
                          <span className="font-medium group-hover:text-red-500 dark:group-hover:text-red-500 transition-colors duration-200">
                            {size.name}
                          </span>
                          <span className="text-xs text-[#6B7280] dark:text-gray-400 group-hover:text-red-500 dark:group-hover:text-red-500 transition-colors duration-200">
        ...
        >
          {previews.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full w-full bg-[#1A1A1A] text-white">
              <Heart className="w-16 h-16 text-gray-500 mb-4" weight="fill" />
              <p className="text-xl font-semibold mb-8">Spinning up preview...</p>
              <div className="flex flex-col items-start space-y-4 text-gray-400 text-lg">
