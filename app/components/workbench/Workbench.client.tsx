...
export const Workbench = memo(
  ({ chatStarted, isStreaming, actionRunner, metadata, updateChatMestaData, sendMessage }: WorkspaceProps) => {
    ...
    const setSelectedView = (view: WorkbenchViewType) => {
      if (view === 'diff') {
        toast.info('Diff view is disabled in free Plan.', {
                  ...
                  {selectedView === 'code' && (
                    <div className="flex overflow-y-auto">
                      <PanelHeaderButton
                        ...
                        onClick={(event) => {
                          const message = "Please fix all the errors. Even if no errors, check the code and try to add better Error Messages. Thanks.";
