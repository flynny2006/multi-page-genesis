...
function CurrentDateTime() {
  ...
  return (
    <div className="flex items-center gap-2 px-4 py-2 text-sm text-gray-600 dark:text-gray-400 border-b border-red-100 dark:border-red-800/50">
    ...
    <>
      <motion.div
        ...
        className={classNames(
          ...
          'bg-white/95 dark:bg-gray-950/95 backdrop-blur-sm border-r border-gray-200 dark:border-gray-800',
          'shadow-lg text-sm',
      ...
      >
        <div className="h-14 flex items-center justify-between px-6 border-b border-gray-200 dark:border-gray-800 bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center justify-center w-10 h-10 overflow-hidden bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 rounded-full shrink-0 ring-2 ring-gray-200 dark:ring-gray-700">
              {profile?.avatar ? (
                <img
                  src={profile.avatar}
        ...
        <div className="flex-1 flex flex-col h-full w-full overflow-hidden">
          <div className="p-4 space-y-4">
            <div className="flex gap-3">
              <a
                href="/"
                className="flex-1 flex gap-2 items-center bg-blue-50 dark:bg-blue-500/10 text-blue-700 dark:text-blue-300 hover:bg-blue-100 dark:hover:bg-blue-500/20 rounded-xl px-4 py-2.5 transition-all duration-200 shadow-sm"
              >
              ...
              <button
                ...
                className={classNames(
                  'flex gap-1 items-center rounded-xl px-3 py-2.5 transition-all duration-200 shadow-sm',
                  selectionMode
            ...
            <div className="relative w-full">
              ...
              <input
                className="w-full bg-gray-50 dark:bg-gray-900 relative pl-9 pr-3 py-2.5 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 text-sm text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-500 border border-gray-200 dark:border-gray-800 shadow-sm transition-all duration-200"
                type="search"
          ...
          <div className="flex-1 overflow-auto px-4 pb-4">
            ...
            <DialogRoot open={dialogContent !== null}>
              {binDates(filteredList).map(({ category, items }) => (
                <div key={category} className="mt-3 first:mt-0 space-y-1.5">
                  <div className="text-xs font-medium text-gray-500 dark:text-gray-400 sticky top-0 z-1 bg-white/95 dark:bg-gray-950/95 backdrop-blur-sm px-4 py-2">
                    {category}
                  </div>
              ...
              <Dialog onBackdrop={closeDialog} onClose={closeDialog}>
                {dialogContent?.type === 'delete' && (
                  <>
                    ...
                    <div className="flex justify-end gap-3 px-6 py-4 bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800">
                  ...
                  <>
                    <div className="p-6 bg-white dark:bg-gray-950">
                      ...
                      <DialogDescription className="mt-2 text-gray-600 dark:text-gray-400">
                        ...
                        <div className="mt-2 max-h-32 overflow-auto border border-gray-200 dark:border-gray-800 rounded-xl bg-gray-50 dark:bg-gray-900 p-3">
