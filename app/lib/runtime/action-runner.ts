...
export class ActionRunner {
  ...
  async #runBuildAction(action: ActionState) {
    ...
    this.onDeployAlert?.({
      ...
      description: 'Building your application... This may take several minutes.',
      stage: 'building',
      buildStatus: 'running',
  ...
  handleDeployAction(
    ...
    isBuildCompletion: boolean = false,
  ): void {
    ...
    if (alertType === 'success' && stage === 'complete' && isBuildCompletion) {
      title = 'Build Completed';
      description = 'Your application was built successfully';
    } else {
      title =
